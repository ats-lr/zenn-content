...
| GPU | 推論時間 | 周波数 | 用途 |
|-----|----------|--------|------|
| H100 (データセンタ) | 38 ms | 26.3 Hz | 学習・大規模推論 |
| RTX 5090 (デスク) | 37 ms | 27.3 Hz | 開発・推論 |
| RTX 4090 (デスク) | 44 ms | 22.8 Hz | 開発・推論 |
| **DGX Spark (エッジ)** | **100 ms** | **10.0 Hz** | **ロボット搭載** |
| Jetson Thor | 105 ms | 9.5 Hz | ロボット搭載 |
| Jetson Orin | 199 ms | 5.0 Hz | 小型ロボット |
